...
HD_PWD='G:/.shortcut-targets-by-id/18l05k5DVoB5pVKzFoiXH5izoP1FLnSFh/Project_group15/uart_final/uart_final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab5top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab5top.tcl -notrace
