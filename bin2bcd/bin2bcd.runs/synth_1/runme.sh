...
HD_PWD='F:/.shortcut-targets-by-id/18l05k5DVoB5pVKzFoiXH5izoP1FLnSFh/Project_group15/bin2bcd/bin2bcd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log binary_bcd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source binary_bcd.tcl
