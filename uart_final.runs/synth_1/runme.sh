...
HD_PWD='G:/.shortcut-targets-by-id/18l05k5DVoB5pVKzFoiXH5izoP1FLnSFh/Project_group15/uart_final/uart_final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab5top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab5top.tcl
